...
- feat(net): best-effort IPv6 listeners + /dns bootstrap shorthand + ::1 proof

## [3.0.21] — 2026-05-30

- feat(provenance): first-class connection_origin end-to-end

## [3.0.20] — 2026-05-30

- feat(net): structured cat= logs on connection/dcutr/relay/autonat + ip_version_str

## [3.0.19] — 2026-05-30

- feat(core): netlog category enum + macro for structured network logs
...
- fix(ui): Connectivity pane + diagnostics always show the real dial mode ("Y7net" / "lan only") instead of "—" / "unknown" — settings are now hydrated at boot.
